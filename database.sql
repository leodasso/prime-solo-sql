...
--The bank is giving a new customer bonus! How do you update all records with 
...
--How do you get the username and account balance of the 3 users with the highest 
-- balances, sorted highest to lowest balance? NOTE: Research LIMIT
SELECT "username", "account_balance" FROM "accounts" 
ORDER BY "account_balance" DESC LIMIT 3;

--How do you get the username and account balance of the 3 users with the lowest 
-- balances, sorted lowest to highest balance?
SELECT "username", "account_balance" FROM "accounts" 
...
VALUES ('leo', 'minneapolis', '150', '175', '149347200');

--The bank is losing money in Miami and Phoenix and needs to unload low transaction 
-- customers: How do you delete users that reside in miami OR phoenix and have completed fewer than 5 transactions.
DELETE FROM "accounts" WHERE "transactions_completed" < 5 AND
("city" = 'miami' OR "city" = 'phoenix');
